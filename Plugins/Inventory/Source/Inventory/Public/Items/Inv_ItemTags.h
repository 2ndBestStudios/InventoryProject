...
// Creates gameplay tags to be used in project. Namespaces provide easily accessibility/organization throughout project
namespace GameItems
{
	namespace Equipment
	{
	...
	namespace Craftables
	{
		...
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(ScorchPedalBlossom)
	}
}