...
{
	// Check to see if we can equip the HoverItem 
	...
	// Inform the server that we've equipped the item (potentially unequipping the item as well) 
...
void UInv_SpatialInventory::EquippedSlottedItemClicked(UInv_EquippedSlottedItem* SlottedItem)
{
	...
	// Remove of the equippped slotted item from the equipped grid slot (unbind from the OnEquippedSlottedItemClicked) 
